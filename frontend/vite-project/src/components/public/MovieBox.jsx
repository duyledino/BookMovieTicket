...
function MovieBox({ Type, film }) {
  ...
  return (
    <>
      <div className="movie w-64">
        <div
          className="overflow-y-hidden relative"
          onMouseEnter={() => setIsHover(true)}
          onMouseLeave={() => setIsHover(false)}
        >
          <img src={poster_path !== undefined?`https://image.tmdb.org/t/p/w500${poster_path}`:tempImg} alt="" />
        ...
        <div className="detail flex flex-col gap-2">
          <h2 className="text-white w-full mt-2 text-2xl">
            {shorten(film_name)}
          </h2>
          <Link
