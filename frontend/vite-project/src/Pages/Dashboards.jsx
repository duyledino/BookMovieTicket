...
function Dashboards() {
  ...
  useEffect(() => {
    const fetchBooking = async () => {
      ...
      if (res.status === 200) {
        ...
        setBookings((old) => [...old,...standardCountBooking(monthArr,totalArr)]);
      }
    };
    fetchBooking();
  }, []);
  ...
  return (
    <div className="container max-w-[85%] m-auto">
      <div className="saleDetailAndTotalRevenue mb-9 min-w-full h-auto p-3 flex gap-x-3 ring-1 ring-white justify-between overflow-y-auto rounded-xl">
        <div className="saleDetail Line flex flex-col w-[65%] p-3 h-auto ring-1 ring-white">
        ...
        <div className="totalRevenue w-[35%] flex flex-col p-3 ring-1 ring-white">
      ...
      <div className="userAndBook p-3 mb-9 min-w-full h-auto flex ring-1 ring-white gap-x-3 justify-between overflow-y-auto rounded-xl">
        <div className="totalBookings p-2 h-auto w-1/2 ring-1 ring-white">
        ...
        <div className="customer p-2 h-auto w-1/2 ring-1 ring-white">
          <div className="title w-full flex justify-between items-center">
      ...
      <div className="TopSellingMovies mb-9 w-[40%] flex p-3 flex-col ring-1 ring-white overflow-y-auto rounded-xl">
