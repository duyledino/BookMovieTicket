...
function Dashboards() {
  ...
  useEffect(() => {
    const fetchWeekDayRevenue = async () => {
      const res = await axios.get(
        `${import.meta.env.VITE_SERVER_URL}/booking/GetTotalWeekDay`,{withCredentials: true}
      );
      console.log(res);
      if (res.status === 200) {
  ...
  useEffect(() => {
    const fetchRevenue = async () => {
      const res = await axios.get(
        `${import.meta.env.VITE_SERVER_URL}/booking/getTotalRevenue`,{withCredentials: true}
      );
      console.log(res);
  ...
  useEffect(() => {
    const fetchBooking = async () => {
      const res = await axios.get(
        `${import.meta.env.VITE_SERVER_URL}/booking/getCountBooking`,{withCredentials: true}
      );
      if (res.status === 200) {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      const res = await axios.get(
        `${import.meta.env.VITE_SERVER_URL}/user/getCountUser`,{withCredentials: true}
      );
      if (res.status === 200) {
  ...
  useEffect(() => {
    const fetchTopMovie = async () => {
      const res = await axios.get(
        `${import.meta.env.VITE_SERVER_URL}/film/topSellingMovie`,{withCredentials: true}
      );
