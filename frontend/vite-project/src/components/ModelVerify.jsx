...
const ModelVerify = ({ isOpen, onClose,onCloseModal, onCreate,setIsChange }) => {
...
//   console.log(location.pathname.split('/'));
  ...
  return (
    <>
      <div className="fixed inset-0 bg-black/55  flex justify-center items-center z-51" onClick={()=>onClose()}>
