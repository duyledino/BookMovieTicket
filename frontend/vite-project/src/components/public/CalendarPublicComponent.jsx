...
function CalendarPublicComponent({calendar}) {
  return (
        ...
        <div className="flex-1 text-[14px] leading-relaxed">
          ...
          <ul className="space-y-5 mb-3">
            <li className="flex items-center gap-2">
              ...
              <span classNameName="text-white text-2xl">Phiêu Lưu, Hành Động</span>
            </li>
            <li className="flex items-center gap-2">
           ...
           <p className="mb-3 text-white uppercase font-bold text-2xl">Standard</p>
